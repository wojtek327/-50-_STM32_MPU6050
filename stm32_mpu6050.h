#ifndef STM32_MPU6050_H_
#define STM32_MPU6050_H_
...
enum gyro_FullScale_e
{
	FS_SEL_250 	= MPU6050_GYRO_FS_250,
	FS_SEL_500 	= MPU6050_GYRO_FS_500,
	FS_SEL_1000 = MPU6050_GYRO_FS_1000,
	FS_SEL_2000	= MPU6050_GYRO_FS_2000
};

enum accel_FullScale_e
{
	AFS_SEL_2g = MPU6050_ACCEL_FS_2,
	AFS_SEL_4g = MPU6050_ACCEL_FS_4,
	AFS_SEL_8g = MPU6050_ACCEL_FS_8,
	AFS_SEL_16g = MPU6050_ACCEL_FS_16
};

enum mpu6050_ClockSource_e
{
	mpu_clk_internal = MPU6050_CLOCK_INTERNAL,
	mpu_clk_pll_xgyro = MPU6050_CLOCK_PLL_XGYRO,
	mpu_clk_pll_ygyro = MPU6050_CLOCK_PLL_YGYRO,
	mpu_clk_pll_zgyro = MPU6050_CLOCK_PLL_ZGYRO,
	mpu_clk_pll_ext32k = MPU6050_CLOCK_PLL_EXT32K,
	mpu_clk_pll_ext19m = MPU6050_CLOCK_PLL_EXT19M,
	mpu_clk_keep_reset = MPU6050_CLOCK_KEEP_RESET
};
...
uint8_t MPU6050_GetExternalSensorByte(const int position);
